    ...
    constructor(options) {
        ...
        this.builds = {
            create: (params) => __awaiter(this, void 0, void 0, function* () {
                let response = yield __classPrivateFieldGet(this, _Client_client, "f").post("/builds", params);
                return response.data;
            }),
            get: (uuid) => __awaiter(this, void 0, void 0, function* () {
                let response = yield __classPrivateFieldGet(this, _Client_client, "f").get(`/builds/${uuid}`);
                return response.data;
            }),
        };
        this.applications = {
             ...
             */
            create: (params) => __awaiter(this, void 0, void 0, function* () {
                let response = yield __classPrivateFieldGet(this, _Client_client, "f").post(`/applications`, params);
                return response.data;
            }),
        };
        this.connectors = {
            ...
            listByPipeline: (pipelineNameOrID) => __awaiter(this, void 0, void 0, function* () {
                let response = yield __classPrivateFieldGet(this, _Client_client, "f").get(`/pipelines/${pipelineNameOrID}/connectors`);
                return response.data;
            }),
            /**
        ...
        this.sources = {
            create: () => __awaiter(this, void 0, void 0, function* () {
                let response = yield __classPrivateFieldGet(this, _Client_client, "f").post("/sources");
                return response.data;
            }),
        };
        this.users = {
